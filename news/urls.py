...
urlpatterns = [    
    ...
    path("api/news/likes_fro_card", views.ToggleNewsLike.as_view(), name="more_news_like"),
    ...
    path('save-news/', views.SaveNewsPage.as_view(), name='save_news'),
    path('save-news/<int:news_page>', views.SaveNewsPage.as_view(), name='save_news_index'),
    path('like-news/', views.LikeNewsPage.as_view(), name="like_news"),
    path('like-news/<int:news_page>', views.LikeNewsPage.as_view(), name="like_news_index"),
